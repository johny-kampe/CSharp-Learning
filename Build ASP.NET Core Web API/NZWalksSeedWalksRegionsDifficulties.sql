USE [NZWalksDatabase]
GO
DELETE FROM [NZWalksDatabase].[dbo].[Regions];
GO
DELETE FROM [NZWalksDatabase].[dbo].[Difficulties];
GO
DELETE FROM [NZWalksDatabase].[dbo].[Walks];
GO
...
GO
Insert into [NZWalksDatabase].[dbo].[Walks]
(Id, Name, Description, LenghtInKm, WalkImgUrl, DifficultyId, RegionId)
values
