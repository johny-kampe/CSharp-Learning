    ...
    public class RegionsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(RegionDto request)
        {
            ...
            { 
                ...
                RequestUri = new Uri($"https://localhost:7143/api/regions/{request.Id}"),
        ...
        public async Task<IActionResult> Delete(RegionDto request)
        {
            try
            {
                ...
                var httpResponseMessage = await client.DeleteAsync($"https://localhost:7143/api/regions/{request.Id}");
